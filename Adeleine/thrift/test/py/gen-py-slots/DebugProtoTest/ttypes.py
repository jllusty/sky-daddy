        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.some_characters = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.STRING:
                    self.zomg_unicode = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                if ftype == TType.BOOL:
...
class CompactProtoTestStruct(object):
    ...
    def __init__(self, a_byte=None, a_i16=None, a_i32=None, a_i64=None, a_double=None, a_string=None, a_binary=None, true_field=None, false_field=None, empty_struct_field=None, byte_list=None, i16_list=None, i32_list=None, i64_list=None, double_list=None, string_list=None, binary_list=None, boolean_list=None, struct_list=None, byte_set=None, i16_set=None, i32_set=None, i64_set=None, double_set=None, string_set=None, binary_set=None, boolean_set=None, struct_set=None, byte_byte_map=None, i16_byte_map=None, i32_byte_map=None, i64_byte_map=None, double_byte_map=None, string_byte_map=None, binary_byte_map=None, boolean_byte_map=None, byte_i16_map=None, byte_i32_map=None, byte_i64_map=None, byte_double_map=None, byte_string_map=None, byte_binary_map=None, byte_boolean_map=None, list_byte_map=None, set_byte_map=None, map_byte_map=None, byte_map_map=None, byte_set_map=None, byte_list_map=None, field500=None, field5000=None, field20000=None,):
        ...
        self.field500 = field500
        self.field5000 = field5000
        self.field20000 = field20000
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i221 in range(_size217):
                        _key222 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                ...
                if ftype == TType.I64:
                    self.field500 = iprot.readI64()
                else:
                    iprot.skip(ftype)
            elif fid == 5000:
                if ftype == TType.I64:
                    self.field5000 = iprot.readI64()
                else:
                    iprot.skip(ftype)
            elif fid == 20000:
                if ftype == TType.I64:
                    self.field20000 = iprot.readI64()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.byte_list_map is not None:
            ...
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.field500 is not None:
            oprot.writeFieldBegin('field500', TType.I64, 500)
            oprot.writeI64(self.field500)
            oprot.writeFieldEnd()
        if self.field5000 is not None:
            oprot.writeFieldBegin('field5000', TType.I64, 5000)
            oprot.writeI64(self.field5000)
            oprot.writeFieldEnd()
        if self.field20000 is not None:
            oprot.writeFieldBegin('field20000', TType.I64, 20000)
            oprot.writeI64(self.field20000)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ExceptionWithAMap(TException):
    ...
    def __init__(self, blah=None, map_field=None,):
        super(ExceptionWithAMap, self).__setattr__('blah', blah)
        super(ExceptionWithAMap, self).__setattr__('map_field', map_field)
    ...
    def __hash__(self):
        return hash(self.__class__) ^ hash((self.blah, self.map_field, ))
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    blah = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.MAP:
...
class ExceptionWithoutFields(TException):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ExceptionWithoutFields')
        oprot.writeFieldStop()
        oprot.writeStructEnd()
                    ...
                    for _i483 in range(_size479):
                        ...
                        for _i496 in range(_size492):
                            ...
                            for _i502 in range(_size498):
                                ...
                                _val504 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
...
CompactProtoTestStruct.thrift_spec = (
    ...
    None,  # 498
    None,  # 499
    (500, TType.I64, 'field500', None, None, ),  # 500
    None,  # 501
    None,  # 502
    None,  # 503
    None,  # 504
    ...
    None,  # 4998
    None,  # 4999
    (5000, TType.I64, 'field5000', None, None, ),  # 5000
    None,  # 5001
    None,  # 5002
    None,  # 5003
    None,  # 5004
    ...
    None,  # 19998
    None,  # 19999
    (20000, TType.I64, 'field20000', None, None, ),  # 20000
)
...
all_structs.append(MutableException)
MutableException.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'msg', 'UTF8', None, ),  # 1
)
all_structs.append(ExceptionWithoutFields)
ExceptionWithoutFields.thrift_spec = (
)
