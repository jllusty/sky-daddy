...
class Xtruct(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.string_thing = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.BYTE:
...
class Xception(TException):
    ...
    def __init__(self, errorCode=None, message=None,):
        super(Xception, self).__setattr__('errorCode', errorCode)
        super(Xception, self).__setattr__('message', message)
...
class Xception2(TException):
    ...
    def __init__(self, errorCode=None, struct_thing=None,):
        super(Xception2, self).__setattr__('errorCode', errorCode)
        super(Xception2, self).__setattr__('struct_thing', struct_thing)
    ...
    def __hash__(self):
        return hash(self.__class__) ^ hash((self.errorCode, self.struct_thing, ))
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.old_string = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 12:
                if ftype == TType.I32:
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.newstring = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 12:
                if ftype == TType.I32:
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.hello = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
                    ...
                    for _i211 in range(_size207):
                        ...
                        for _i217 in range(_size213):
                            ...
                            for _i224 in range(_size220):
                                _elem225 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
...
class OptionalSetDefaultTest(object):
    """
    Attributes:
     - with_default
    ...
    def __init__(self, with_default=set((
        "test",
    )),):
        if with_default is self.thrift_spec[1][4]:
            with_default = set((
                "test",
            ))
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.SET:
                    self.with_default = set()
                    (_etype266, _size263) = iprot.readSetBegin()
                    for _i267 in range(_size263):
                        _elem268 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.with_default.add(_elem268)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('OptionalSetDefaultTest')
        if self.with_default is not None:
            oprot.writeFieldBegin('with_default', TType.SET, 1)
            oprot.writeSetBegin(TType.STRING, len(self.with_default))
            for iter269 in self.with_default:
...
class OptionalBinary(object):
    ...
    def __init__(self, bin_set=set((
    )), bin_map={
    },):
        if bin_set is self.thrift_spec[1][4]:
            bin_set = set((
            ))
        self.bin_set = bin_set
        if bin_map is self.thrift_spec[2][4]:
            bin_map = {
            }
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('OptionalBinary')
        if self.bin_set is not None:
            oprot.writeFieldBegin('bin_set', TType.SET, 1)
            oprot.writeSetBegin(TType.STRING, len(self.bin_set))
            for iter283 in self.bin_set:
                oprot.writeBinary(iter283)
            oprot.writeSetEnd()
            oprot.writeFieldEnd()
        if self.bin_map is not None:
            oprot.writeFieldBegin('bin_map', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.I32, len(self.bin_map))
            for kiter284, viter285 in self.bin_map.items():
                oprot.writeBinary(kiter284)
                oprot.writeI32(viter285)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
all_structs.append(OptionalSetDefaultTest)
OptionalSetDefaultTest.thrift_spec = (
    None,  # 0
    (1, TType.SET, 'with_default', (TType.STRING, 'UTF8', False), set((
        "test",
    )), ),  # 1
)
all_structs.append(OptionalBinary)
OptionalBinary.thrift_spec = (
    None,  # 0
    (1, TType.SET, 'bin_set', (TType.STRING, 'BINARY', False), set((
    )), ),  # 1
    (2, TType.MAP, 'bin_map', (TType.STRING, 'BINARY', TType.I32, None, False), {
    }, ),  # 2
)
