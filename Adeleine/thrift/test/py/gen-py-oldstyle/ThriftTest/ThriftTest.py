        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.thing = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class testMap_args:
    ...
    def write(self, oprot):
        ...
        if self.thing is not None:
            ...
            for kiter293, viter294 in self.thing.items():
                oprot.writeI32(kiter293)
                oprot.writeI32(viter294)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class testMap_result:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter302, viter303 in self.success.items():
                oprot.writeI32(kiter302)
...
class testStringMap_args:
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    ...
                    for _i308 in range(_size304):
                        ...
                        _val310 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.thing[_key309] = _val310
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.thing is not None:
            ...
            for kiter311, viter312 in self.thing.items():
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.SET:
                    self.success = set()
                    (_etype332, _size329) = iprot.readSetBegin()
                    for _i333 in range(_size329):
                        _elem334 = iprot.readI32()
                        self.success.add(_elem334)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i354 in range(_size350):
                        ...
                        for _i361 in range(_size357):
                            ...
                            _val363 = iprot.readI32()
                            _val356[_key362] = _val363
                        iprot.readMapEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter364, viter365 in self.success.items():
                ...
                oprot.writeMapBegin(TType.I32, TType.I32, len(viter365))
                for kiter366, viter367 in viter365.items():
                ...
                if ftype == TType.MAP:
                    ...
                    for _i372 in range(_size368):
                        ...
                        for _i379 in range(_size375):
                            ...
                            _val381 = Insanity.read(iprot)
                            _val374[_key380] = _val381
                        iprot.readMapEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter382, viter383 in self.success.items():
                oprot.writeI64(kiter382)
                oprot.writeMapBegin(TType.I32, TType.STRUCT, len(viter383))
                for kiter384, viter385 in viter383.items():
                    oprot.writeI32(kiter384)
...
class testMulti_args:
    ...
    def write(self, oprot):
        ...
        if self.arg3 is not None:
            ...
            for kiter393, viter394 in self.arg3.items():
                oprot.writeI16(kiter393)
...
class testException_args:
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.arg = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class testMultiException_args:
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.arg0 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
                    self.arg1 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.err2 = Xception2.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
